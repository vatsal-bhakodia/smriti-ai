...
export default function LoginForm({
  ...
  // Reset to step 1 if enrollment number is cleared
  useEffect(() => {
    if (!enrollmentNumber.trim() && currentStep === 2) {
      setCurrentStep(1);
    }
  }, [enrollmentNumber, currentStep]);
  ...
  return (
    <>
      {/* Password Information Warning Box - Only show on step 2 */}
      {currentStep === 2 && (
        ...
        <CardContent className="p-6">
          ...
          {currentStep === 1 && (
            <form onSubmit={handleNext} className="space-y-4">
              ...
              <Button
                type="submit"
                disabled={isLoading || !enrollmentNumber.trim()}
                className="w-full bg-primary hover:bg-lime-400 text-black font-semibold py-4 text-base flex items-center justify-center gap-2"
              >
                Next
          ...
          {currentStep === 2 && (
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <Button
                ...
                variant="ghost"
                onClick={handleBack}
                className="text-zinc-400 hover:text-white mb-2 -mt-2"
              >
              ...
              <div className="space-y-2">
                <Label htmlFor="enrollment-display" className="text-white">
                  Enrollment Number
                </Label>
                <Input
