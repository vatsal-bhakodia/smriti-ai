...
import ExamNotices from "@/components/result/ExamNotices";

export const metadata = generateMetadataUtil({
  title: "IPU Results 2025-2026 (GGSIPU) with CGPA Calculation",
  description:
    "Check IPU Results 2025-2026 for GGSIPU courses instantly. View subject-wise marks, SGPA/CGPA calculator, and download result PDF. Trusted by IPU students in Delhi & India.",
  keywords: [
    "ipu result",
    "ipu result portal",
    "ggsipu result",
    ...
    <>
      ...
      <div className="min-h-[70vh] p-4 relative z-0 pb-20">
        ...
        <div className="w-full max-w-5xl mx-auto mt-12 space-y-12">
          {/* Examination Notices Section */}
          <ExamNotices />

          {/* FAQ Section */}
          <section className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 rounded-2xl p-4 md:p-8">
            <h2 className="text-xl md:text-2xl font-bold text-white mb-6 flex items-center justify-center gap-2">
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-zinc-900 via-zinc-900/95 to-zinc-800 border border-zinc-800 rounded-2xl hover:border-lime-500/50 hover:shadow-lg hover:shadow-lime-500/10 transition-all duration-300">
              ...
              <div className="relative p-4 md:p-8">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                  ...
                  {/* Right Section - CTA */}
                  <div className="p-4 md:w-fit w-full flex justify-center items-center gap-2
                   bg-lime-500/10 rounded-xl border border-lime-500/20 group-hover:bg-lime-500/20 group-hover:border-lime-500/40 transition-all duration-300">
          ...
          <section className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 rounded-2xl p-4 md:p-8">
            <h2 className="text-xl md:text-2xl font-bold text-white mb-6 flex items-center gap-2">
              <Database className="hidden md:inline-block h-8 w-8 text-primary" />
